...
def generate_template(jc_number, issue_date, area, spools, sgs_df):
    ...
    worksheet.insert_image('A1', 'Logo/BR.png', {'x_offset': 50, 'y_offset': 10, 'x_scale': 1, 'y_scale': 1})
    worksheet.insert_image('I1', 'Logo/Seatrium.png', {'x_offset': 50, 'y_offset': 10, 'x_scale': 1, 'y_scale': 1})
